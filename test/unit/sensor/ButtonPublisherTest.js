...
describe('Test ButtonPublisher', function() {
  describe('#constructor(topic, button)', function() {
    ...
    function expectInvalidButton(error) {
      ...
      assert(error.message === 'button argument was not of type ' +
                               'HTMLButtonElement');
    ...
    it('should reject any button argument that is not an HTML Button',
        function() {
          assert.throws(
              () => {
    ...
    it('should reject any topic argument that is not a ROSLIB.Topic instance',
        function() {
          assert.throws(
              () => {
                new ButtonPublisher('not a topic',
    ...
    it('should accept a ROSLIB.Topic and an HTML Button as arguments',
        function() {
          let publisher;
  ...
  describe('#start()', function() {
    it('should subscribe onMouseUp and onMouseDown callbacks to correct events',
        function() {
          ...
          assert(button.addEventListener.calledWith('mouseup',
              publisher.onMouseUp));
          assert(button.addEventListener.calledWith('mousedown',
              publisher.onMouseDown));
        });
  });

  describe('#onMouseUp()', function() {
    it('should publish a sts_msgs/Bool message to topic upon callback',
        function() {
          const button = document.createElement('button');
